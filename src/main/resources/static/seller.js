...
function setToppingValue(inputId, value) {
    const stockByInput = { arequipe: inventoryStock.arequipeQuantity, powderedMilk: inventoryStock.powderedMilkQuantity, raisins: inventoryStock.raisinsQuantity };
    $(inputId).value = Math.min(stockByInput[inputId], Math.max(0, value));
